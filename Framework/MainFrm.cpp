...
{
	MYTRACE("general")(MT::LEVEL_DEBUG, "Getting Message to UpdateViews...");
	...
	MYTRACE("general")(MT::LEVEL_DEBUG, "Updating all Views done\n");
...
{
	MYTRACE("general")(MT::LEVEL_DEBUG, "Getting Message to Show CombatView...");
...
{
	MYTRACE("general")(MT::LEVEL_DEBUG, "Getting Message to InitViews...");
...
//  Message disturbes, every time when hidden menu bar gets visible
//	pDC->SetTextColor(RGB(200,200,200));
