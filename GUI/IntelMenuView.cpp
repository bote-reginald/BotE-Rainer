...
void CIntelMenuView::DrawIntelInfoMenu(Graphics* g)
{
	...
	if (m_sActiveIntelRace != "")
	{
		...
		MYTRACE("logdata")(MT::LEVEL_INFO, "Race: %s \n", m_sActiveIntelRace);
		if (graphic == NULL)
			graphic = pDoc->GetGraphicPool()->GetGDIGraphic("Symbols\\Default.bop");
		if (graphic)
		...
		MYTRACE("logdata")(MT::LEVEL_INFO, "CONTROLLED_SECTORS: %s \n", s);
		...
		MYTRACE("logdata")(MT::LEVEL_INFO, "CONTROLLED_SYSTEMS: %s \n", s);
		...
		MYTRACE("logdata")(MT::LEVEL_INFO, "INHABITED_SYSTEMS: %s \n", s);
		...
		MYTRACE("logdata")(MT::LEVEL_INFO, "KNOWN_MINORRACES: %s \n", s);
		...
		MYTRACE("logdata")(MT::LEVEL_INFO, "NUMBER_OF_MINORMEMBERS: %s \n---------\n", s);
