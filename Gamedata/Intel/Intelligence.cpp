...
void CIntelligence::Serialize(CArchive &ar)
{
	...
	if (ar.IsStoring())
	{
		MYTRACE("logsave")(MT::LEVEL_DEBUG, "Intelligence.CPP: Race: # %s #, InnSecP:%d, InnSecStorage:%d, InnSecBoni:%d, MakeResponsible:%s\n", m_sRace, m_iSecurityPoints, m_iInnerStorage, m_nInnerSecurityBoni, m_sResponsibleRace); 
		//MYTRACE("logsave")(MT::LEVEL_DEBUG, "Intelligence.CPP: m_sResponsibleRace: %s, \n", m_sResponsibleRace); 
		//MYTRACE("logsave")(MT::LEVEL_DEBUG, "Intelligence.CPP: m_iSecurityPoints: %d\n", m_iSecurityPoints); 
		//MYTRACE("logsave")(MT::LEVEL_DEBUG, "Intelligence.CPP: m_iInnerStorage: %d\n", m_iInnerStorage); 
		//MYTRACE("logsave")(MT::LEVEL_DEBUG, "Intelligence.CPP: m_nInnerSecurityBoni: %d\n", m_nInnerSecurityBoni); 
		//MYTRACE("logsave")(MT::LEVEL_DEBUG, "Intelligence.CPP: -------------------\n"); 
