...
void CShipInfo::CalculateMaintenanceCosts()
{
		...
		// race value 		/*mcosts = U-Modifikatoren pro Rasse	0,64Terra, 	0,34Han, 0,88Kha, 0,65Roth, 0,60Car, 0,78Ome, 0,65Minor (=Major-Schnitt)*/
		int racemodevalue = 0;
		switch (this->GetRace())
							{
