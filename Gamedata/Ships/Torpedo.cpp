...
/*	CString dam;
	dam.Format("Torpedoschaden an Schiff # %s (%s) # zuvor: Schilde: %d Hülle: %d Torpedoschaden: %d",
...
/*CString damage;
	dam.Format("Torpedoschaden an Schiff # %s (%s) # nachher: Schilde: %d Hülle: %d Torpedoschaden: %d",
		CS->m_pShip->GetShipName(), CS->m_pShip->GetShipClass(), CS->m_pShip->GetShield()->GetCurrentShield(),
		CS->m_pShip->GetHull()->GetCurrentHull(), torpedoDamage);
